...
import { TEST_ACCOUNT_IFI, TEST_IFI, TEST_ORGANISATION, TEST_ORGANISATION_OUTSIDE_STORE } from '../utils/values';
...
describe('createIdentifier', () => {
  ...
  it('Should create identifiers in different organisations', async () => {
    const persona = await createTestPersona();
    const otherOrgPersona = await createTestPersona('otherorg person', TEST_ORGANISATION_OUTSIDE_STORE);
