import type CommonService from '@hiram-labs/lrs-js-common/dist/serviceFactory/Service';
...
interface Service extends CommonService {
  ...
  readonly createUpdateIdentifierPersona: (
    opts: CreateUpdateIdentifierPersonaOptions
  ) => Promise<CreateUpdateIdentifierPersonaResult>;
  readonly overwritePersonaAttribute: (
    opts: OverwritePersonaAttributeOptions
  ...
  readonly getPersonaIdentifierCount: (
    opts: GetPersonaIdentifierCountOptions
